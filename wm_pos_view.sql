...
select distinct rs.id, model_tool.model,model_tool.division, rs.tool_id, pn.product_name, g.group_id, cbm.cat, wmc.item_id as base_id, rs.sale_date, rs.wm_week, rs.brand_name
from rs
