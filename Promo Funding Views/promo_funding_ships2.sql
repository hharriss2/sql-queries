 ...
 SELECT t1.pfid,
  ...
  GROUP BY t1.pfid, m.model_id, d.division_id, cbm.cbm_id, t.tool_id_id, a.account_manager_id, pn.product_name_id, t1.funding_amt, t1.suggested_retail, g.group_id_id, pt.promo_id, wmw1.wmcal_id, wmw2.wmcal_id, rp.retail_price_id
  )
  ;